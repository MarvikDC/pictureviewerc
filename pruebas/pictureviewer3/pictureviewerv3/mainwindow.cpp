    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->push_change->setVisible(0);
    pix=QPixmap("C:/Users/alogistica2/Dropbox (Personal)/ULS/S3/LP2/CLASES/0-final/qt/pictureviewer3/pictureviewerv3/images/fondo");
...
void MainWindow::on_push_add_clicked()
{
    ...
    QString tem_path= QFileDialog::getOpenFileName(this,"select Picture","C:/Users/alogistica2/Dropbox (Personal)/ULS/S3/LP2/CLASES/0-final/qt/pictureviewer3/pictureviewerv3/images");
    ui->line_path->setText(tem_path);
}
...
void MainWindow::load_list(linked_list<picture> &Va2)
{
    ifstream binfs;
        ...
        while (binfs.read((char*)&size_tmp1,sizeof(size_t)))
        {
            //load.x=x_tmp;
           ...
           // cout<<"size of sizetemp:"<<sizeof(size_tmp)<<endl;
            ...
            binfs.read((char*)&size_tmp2,sizeof(size_t));
...
void MainWindow::on_push_edit_clicked()
{
    ui->push_change->setVisible(1);
    ui->line_name->setEnabled(1);
    ui->line_path->setEnabled(1);

}

void MainWindow::on_push_change_clicked()
{
    QString tmp_name = ui->line_name->text();
    QString tmp_path = ui->line_path->text();
    it.my_node()->dato.edit_data(tmp_name.toStdString(),tmp_path.toStdString());
    ui->push_change->setVisible(0);
    ui->line_name->setEnabled(0);
    ui->line_path->setEnabled(0);
}
